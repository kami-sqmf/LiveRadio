...
struct raop_callbacks_s {
    ...
    /* Airplay Radio: associate remote control with the actual RTSP peer. */
    void (*remote_control)(void *cls, const void *connection, const char *peer, const char *dacp_id, const char *token);
    void (*remote_control_closed)(void *cls, const void *connection);
    void (*audio_resend_requested)(void *cls, unsigned int count);
};
