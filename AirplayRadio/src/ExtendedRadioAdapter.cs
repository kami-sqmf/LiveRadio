...
namespace AirplayRadio
{
    ...
    {
        private const string PatchId = "AirplayRadio.NativePanel";
        ...
        internal void PatchPanel()
        {
            ...
            Prefix(typeof(Radio), nameof(Radio.NextSong), typeof(RemoteNextPatch));
            Prefix(typeof(Radio), nameof(Radio.PreviousSong), typeof(RemotePreviousPatch));
            Prefix(typeof(RadioUISystem), "SetPaused", typeof(RemotePausePatch));
        }
