...
| [Settings](settings.en.jpg) | FFmpeg detection and paused stream status |
| [Thumbnail](thumbnail.png) | Original Live Radio title artwork |

The screenshots are unedited captures of Live Radio 0.4.4, normal build, in Cities: Skylines II 1.6.0f1. Other mods are enabled in this playset; these images are not evidence of a clean-playset test. Platform image requirements still need to be checked at upload time.
